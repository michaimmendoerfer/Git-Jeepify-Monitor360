...
void ui_ScrSwitch_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_ScrSwitch, &ui_img_btn_off_png, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_obj_set_y(ui_LblSwitchPeer, 130);
    ...
    lv_obj_set_y(ui_LblSwitchPeriph, -135);

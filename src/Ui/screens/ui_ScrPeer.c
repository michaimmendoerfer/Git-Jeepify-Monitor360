...
void ui_ScrPeer_screen_init(void)
{
    ...
    lv_obj_set_x(ui_LblPeerName, -5);
    lv_obj_set_y(ui_LblPeerName, 115);
    ...
    lv_obj_set_width(ui_Container3, 223);
    lv_obj_set_height(ui_Container3, 211);
    ...
    lv_obj_set_x(ui_BtnPeer7, lv_pct(-20));
    lv_obj_set_y(ui_BtnPeer7, lv_pct(-25));

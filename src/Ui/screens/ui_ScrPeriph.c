...
void ui_ScrPeriph_screen_init(void)
{
    ...
    lv_obj_set_x(ui_ImgPeerChoice, lv_pct(0));
    lv_obj_set_y(ui_ImgPeerChoice, lv_pct(-15));
    ...
    lv_obj_set_y(ui_LblPeriphChoicePeer, lv_pct(35));
    ...
    lv_obj_set_style_text_font(ui_LblPeriphChoicePeer, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LblPeriphChoiceType, lv_pct(0));
    lv_obj_set_y(ui_LblPeriphChoiceType, lv_pct(13));
    ...
    lv_obj_set_x(ui_LblPeriphChoiceOnline, lv_pct(0));
    lv_obj_set_y(ui_LblPeriphChoiceOnline, lv_pct(20));
    ...
    lv_obj_set_x(ui_LblPeriphChoicePeriph, lv_pct(0));
    lv_obj_set_y(ui_LblPeriphChoicePeriph, lv_pct(6));
